    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.nav}>
          <img className={styles.nav__item} src={pieChartIcon} alt="icon" />
          <img className={styles.nav__item} src={pieChart} alt="icon" />
          <img className={styles.nav__item} src={barChart} alt="icon" />
        </div>
      </div>
